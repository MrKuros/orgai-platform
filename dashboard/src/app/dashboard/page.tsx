...
export default function DashboardPage() {
  ...
  const violationCount = auditData?.total || 0;

  const isLoading = !policiesData || !rolesData || !membersData || !auditData || !recentActivity;
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className={`text-2xl font-bold ${violationCount > 0 ? 'text-destructive' : ''}`}>{violationCount}</div>
